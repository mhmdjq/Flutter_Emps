...
void _employeeSerialize(
  ...
  writer.writeDouble(offsets[2], object.salary);
}
...
Employee _employeeDeserialize(
  ...
  object.salary = reader.readDouble(offsets[2]);
  return object;
}
...
extension EmployeeQueryFilter
  ...
  QueryBuilder<Employee, Employee, QAfterFilterCondition> ageEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Employee, Employee, QAfterFilterCondition> ageGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Employee, Employee, QAfterFilterCondition> ageLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Employee, Employee, QAfterFilterCondition> ageBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Employee, Employee, QAfterFilterCondition> salaryEqualTo(
    double value, {
...
extension EmployeeQuerySortBy on QueryBuilder<Employee, Employee, QSortBy> {
  QueryBuilder<Employee, Employee, QAfterSortBy> sortByAge() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'age', Sort.asc);
    });
  }

  QueryBuilder<Employee, Employee, QAfterSortBy> sortByAgeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension EmployeeQuerySortThenBy
  ...
  QueryBuilder<Employee, Employee, QAfterSortBy> thenByAge() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'age', Sort.asc);
    });
  }

  QueryBuilder<Employee, Employee, QAfterSortBy> thenByAgeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'age', Sort.desc);
    });
  }
...
extension EmployeeQueryWhereDistinct
  ...
  QueryBuilder<Employee, Employee, QDistinct> distinctByAge() {
    return QueryBuilder.apply(this, (query) {
...
extension EmployeeQueryProperty
  ...
  QueryBuilder<Employee, int, QQueryOperations> ageProperty() {
    return QueryBuilder.apply(this, (query) {
